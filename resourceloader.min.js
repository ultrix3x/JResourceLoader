...
b._loadScript=function(c,a){var d=null;a=a||{};if(!1!==a.cacheName&&(d=this.storage.get(a.cacheName,a.cacheTimeout),null!=d))return a.loadedFrom="cache",b._appendScript(d,a);b._fetchData(c,a,b._appendScript)};b._appendScript=function(c,a){var d=e.getElementsByTagName("head")[0],b=e.createElement("script");b.appendChild(e.createTextNode(c));d.appendChild(b);a.loadCount--;a&&a.complete&&a.complete.call&&a.complete.call(a.self,a)};b._loadStyle=function(c,a){var d=null;a=a||{};if(!1!==a.cacheName&&(d=
this.storage.get(a.cacheName,a.cacheTimeout),null!=d))return a.loadedFrom="cache",b._appendStyle(d,a);b._fetchData(c,a,b._appendStyle)};b._appendStyle=function(c,a){var d=e.getElementsByTagName("head")[0],b=e.createElement("style");b.appendChild(e.createTextNode(c));d.appendChild(b);a.loadCount--;a&&a.complete&&a.complete.call&&a.complete.call(a.self,a)};b._fetchData=function(c,a,b){a.self=this;if(f.jQuery)f.jQuery.ajax({url:c,dataType:"text",success:function(c){a&&!1!==a.cacheName&&a.self.storage.set(a.cacheName,
