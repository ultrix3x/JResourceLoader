...
a.complete.call(a.self,c,a)}});else if(f.XMLHttpRequest){var b=new f.XMLHttpRequest;a.loadCount++;b.onreadystatechange=function(){if(4==b.readyState){a.loadedFrom="web/xhr";var e=b.responseText;a&&!1!==a.cacheName&&a.self.storage.set(a.cacheName,e);d&&d.call?d.call(a.self,response,a):a&&a.complete&&a.complete.call&&a.complete.call(a.self,c,a)}};b.open("GET",c,!0);b.send(null)}};b.getVersion=function(){return this.version.text};f.resourceLoader=b};if(e.version==n||e&&e.version&&(e.version.major<g.major||
e.version.major==g.major&&(e.version.minor<g.minor||e.version.minor==g.minor&&e.version.sub<g.sub)))return p(l,m,e)})(window,document,window.resourceLoader||{});